...
export function activate(context: vscode.ExtensionContext): void {
	...
	const clockInterval = (clock: vscode.StatusBarItem): void => {
		let time: string;
		setInterval(() => {
	...
	let leftClock = vscode.commands.registerCommand(
		'status-clock.leftSide',
		() => {
			clockInterval(lClock);
		});

	let rightClock = vscode.commands.registerCommand(
		'status-clock.rightSide',
		() => {
			clockInterval(rClock);
		},);

	let noEmojiClockLeft = vscode.commands.registerCommand(
		'status-clock.noEmojiLeft',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
	...
	let noEmojiClockRight = vscode.commands.registerCommand(
		'status-clock.noEmojiRight',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
	...
	let noSecondsClockLeft = vscode.commands.registerCommand(
		'status-clock.noSecondsLeft',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
	...
	let noSecondsClockRight = vscode.commands.registerCommand(
		'status-clock.noSecondsRight',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
	...
	let noSecondsNoEmojiLeft = vscode.commands.registerCommand(
		'status-clock.noSecondsNoEmojiLeft',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
	...
	let noSecondsNoEmojiRight = vscode.commands.registerCommand(
		'status-clock.noSecondsNoEmojiRight',
		() => {
			let time;
			setInterval(() => {
				time = new Date().toLocaleTimeString();
